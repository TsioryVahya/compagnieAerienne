-- ============================================
-- TABLES POUR LA GESTION DES PUBLICITÉS
-- ============================================
...
-- Permet de gérer l'évolution des prix dans le temps
...
-- Une ligne = un ensemble de diffusions d'une pub sur un vol
...
-- ============================================
-- TABLE ET VUES POUR LES PAIEMENTS
-- ============================================
...
-- Exemples de sociétés (selon l'image fournie)
