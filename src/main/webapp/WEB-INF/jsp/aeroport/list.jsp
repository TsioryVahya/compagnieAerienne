...
<main class="main-content-wrapper">
    <div class="main-content">
                ...
                <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 mb-2">Aéroports</h1>
                        <!-- Breadcrumb -->
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Aéroports</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div class="flex gap-3">
                        <a href="/aeroports/create" class="bg-brand-600 text-white px-4 py-2 rounded-md hover:bg-brand-700 shadow-sm transition-colors text-sm font-medium flex items-center gap-2">
