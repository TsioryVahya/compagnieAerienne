...
<main class="main-content-wrapper">
    <div class="main-content" style="max-width: 48rem; margin: 0 auto;">
                ...
                <div class="mb-8">
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">${aeroport.id != null ? 'Modifier' : 'Nouveau'} Aéroport</h1>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="/aeroports" class="ml-1 text-sm font-medium text-gray-500 hover:text-brand-600 md:ml-2">Aéroports</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <form action="/aeroports/save" method="post" class="space-y-6">
                        <input type="hidden" name="id" value="${aeroport.id}">
                        
                        <div>
                            <label for="nom" class="block text-sm font-medium text-gray-700 mb-2">Nom de l'Aéroport</label>
                            <input type="text" name="nom" id="nom" value="${aeroport.nom}" required
                        ...
                        <div class="flex gap-3 pt-4">
                            ...
                            <a href="/aeroports" class="bg-gray-100 text-gray-700 px-6 py-2 rounded-md hover:bg-gray-200 shadow-sm transition-colors text-sm font-medium">
                                Annuler
                            </a>
                        </div>
                    </form>
