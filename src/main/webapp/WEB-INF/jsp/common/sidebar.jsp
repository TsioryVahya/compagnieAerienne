...
<aside class="w-64 bg-gradient-to-b from-emirates-darkGray to-emirates-black border-r border-brand-600 hidden md:flex flex-col h-screen fixed inset-y-0 left-0 z-10">
    <!-- Logo Area -->
    <div class="h-16 flex items-center px-6 border-b border-brand-600 bg-gradient-to-r from-brand-700 to-brand-600 shadow-lg">
        <div class="flex items-center gap-2 font-semibold text-brand-300 text-lg font-display">
            <div class="w-8 h-8 bg-brand-400 rounded-md flex items-center justify-center text-emirates-black shadow-lg">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        <!-- Section: Core -->
        <div class="px-3 mb-4 text-xs font-semibold text-brand-400 uppercase tracking-wider font-display">
            Tableau de Bord
        </div>
        <% String activePage = (String) request.getAttribute("activePage"); %>
        
        <a href="/" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-md group transition-all duration-200 <%= "home".equals(activePage) ? "bg-gradient-to-r from-brand-500 to-brand-600 text-white shadow-lg ring-1 ring-brand-400" : "text-brand-200 hover:bg-brand-700 hover:text-white" %>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 transition-colors">
        ...
        <!-- Section: Operations -->
        <div class="px-3 mt-6 mb-4 text-xs font-semibold text-brand-400 uppercase tracking-wider font-display">
            Opérations
        </div>
        
        <a href="/vols" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium rounded-md group transition-all duration-200 <%= "vols".equals(activePage) ? "bg-gradient-to-r from-brand-500 to-brand-600 text-white shadow-lg ring-1 ring-brand-400" : "text-brand-200 hover:bg-brand-700 hover:text-white" %>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 transition-colors">
