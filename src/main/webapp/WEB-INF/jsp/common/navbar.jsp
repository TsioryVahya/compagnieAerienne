...
<header class="h-16 bg-gradient-to-r from-white to-brand-50 border-b border-brand-300 flex items-center justify-between px-6 z-20 shadow-md">
    ...
    <div class="flex items-center gap-4 flex-1">
        ...
        <div class="relative w-full max-w-md hidden sm:block">
            ...
            <input type="text" name="search" id="search" class="block w-full pl-10 pr-3 py-2 border border-brand-200 rounded-md leading-5 bg-white placeholder-brand-400 focus:outline-none focus:placeholder-brand-500 focus:ring-2 focus:ring-brand-400 focus:border-brand-500 sm:text-sm shadow-sm" placeholder="Rechercher (Ctrl+K)">
        </div>
    </div>
