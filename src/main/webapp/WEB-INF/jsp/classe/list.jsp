...
<main class="main-content-wrapper">
    <div class="main-content">
                ...
                <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 mb-2">Classes</h1>
                        <!-- Breadcrumb -->
                    ...
                    <div class="flex gap-3">
                        <a href="/classes/create" class="bg-brand-600 text-white px-4 py-2 rounded-md hover:bg-brand-700 shadow-sm transition-colors text-sm font-medium flex items-center gap-2">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        <h3 class="text-lg font-medium text-gray-900">Liste des Classes</h3>
                    </div>
                            ...
                            <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                                <c:forEach items="${classes}" var="classe">
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-3 font-medium text-brand-600">${classe.id}</td>
                                        <td class="px-6 py-3 font-medium text-gray-900">${classe.nom}</td>
                                        <td class="px-6 py-3 flex justify-end gap-3">
                                            <a href="/classes/edit/${classe.id}" class="text-brand-600 hover:text-brand-800" title="Modifier">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                                </svg>
                                            </a>
                                            <a href="/classes/${classe.id}/delete" class="text-red-600 hover:text-red-800" title="Supprimer" onclick="return confirm('Supprimer cette classe ?')">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
