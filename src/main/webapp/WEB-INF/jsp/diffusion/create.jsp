    ...
    <div class="flex-1 flex flex-col overflow-hidden transition-all duration-300">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
            <div class="container mx-auto max-w-2xl">
                ...
                <div class="mb-8">
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">${diffusion.id == null ? 'Nouvelle Diffusion' : 'Modifier Diffusion'}</h1>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="/diffusions" class="ml-1 text-sm font-medium text-gray-500 hover:text-brand-600 md:ml-2">Diffusions</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <form action="/diffusions/save" method="post" class="space-y-6">
                        <input type="hidden" name="id" value="${diffusion.id}">

                        <div>
                            <label for="nom" class="block text-sm font-medium text-gray-700 mb-2">Nom de la Diffusion</label>
                            <input type="text" name="nom" id="nom" value="${diffusion.nom}" required
                        ...
                        <div>
                            <label for="societe" class="block text-sm font-medium text-gray-700 mb-2">Société Cliente</label>
                            <select name="societe.id" id="societe" required
                                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent">
                                <option value="">Sélectionner une société</option>
                                <c:forEach items="${societes}" var="s">
                                    <option value="${s.id}" ${diffusion.societe.id == s.id ? 'selected' : ''}>${s.nom}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <div class="flex gap-3 pt-4">
                            ...
                            <a href="/diffusions" class="bg-gray-100 text-gray-700 px-6 py-2 rounded-md hover:bg-gray-200 shadow-sm transition-colors text-sm font-medium">
                                Annuler
                            </a>
                        </div>
                    </form>
